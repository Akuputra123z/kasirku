...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        // Sales growth (transaction count month-over-month)
        ...
        // Orders growth (month-over-month, same as sales count for now)
        $ordersGrowth = $salesGrowth;

        // Year-over-year growth (last 6 months vs previous 6 months)
        ...
        $netRevenue = $totalSubtotal - $totalDiscount;

        $earningBreakdown = [
            ['category' => 'Revenue', 'value' => round(($netRevenue / $totalSubtotal) * 100), 'fill' => 'var(--color-chart-1)'],
